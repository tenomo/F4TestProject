...
namespace F4TestProject.API.Models
{
    public class ActionItemRequest
    {
        ...
        [StringLength(maximumLength: 128, MinimumLength = 1,
            ErrorMessage = "The title cannot be more than 128 characters and less than 1 character.")]
        public string Title
        {
            get => _title;
        ...
        [RegularExpression(@"(https?:\/\/.*\.(?:png|jpg))",
            ErrorMessage = "The field 'ImageLink' has a symbol/s that is not allowed.")]
